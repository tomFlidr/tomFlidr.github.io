...
var xhr = Ajax.load({
	...
	success: function (data, statusCode, xhr, requestId, url, type) {
		// data:Object, statusCode:Number, xhr:XMLHttpRequest|Null, requestId:Number, url:String, type:String
	},
	type: 'json', // json|jsonp|xml|html|text
	error: function (responseText, statusCode, xhr, requestId, url, type) {
		// responseText:String, statusCode:Number, xhr:XMLHttpRequest|Null, requestId:Number, url:String, type:String
	},
	headers: {},
	async: true
});
