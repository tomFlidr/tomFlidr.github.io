...
declare interface Ajax {
    ...
    */
    handlers: {
        ...
        success: ((xhr?: XMLHttpRequest | null, requestId?: number, url?: string, type?: string) => void)[],
        abort: ((xhr?: XMLHttpRequest | null, requestId?: number, url?: string, type?: string) => void)[],
        error: ((xhr?: XMLHttpRequest | null, requestId?: number, url?: string, type?: string) => void)[]
    };
    /**
    ...
    */
    get (
        ...
        error?: (responseText?: string, statusCode?: number, xhr?: XMLHttpRequest | null, requestId?: number, url?: string, type?: string) => void,
        headers?: object,
        async?: boolean
...
declare namespace Ajax {
    ...
    interface JsonpRequest {
        /**
         * Full appended &lt;script&gt; tag src attribute value.
         * @type {string}
         */
        url: string;
        /**
        ...
        id: number;
        /**
         * Function to abort JSONP request.
         * @return {void}
         */
        abort: () => void;
    }
    ...
    interface LoadConfig {
        /**
         * Required, url string to send the GET request, relative or absolute.
         * @type {string}
         */
        url: string;
        /**
         * HTTP request method - only if request type is not JSONP.
         * @type {string}
         */
        method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH';
        /**
         * Optional, default: `{}`. Object with key/value data to be serialized into query string and sended in url, any complext value will be automaticly stringified by `JSON.stringify();`, (JSON shim is inclided in this Ajax.js library).
         * @type {any}
         */
        data?: any;
        /**
         * Optional, custom callback after everything is done and if response HTTP code is bigger than 199 and lower than 300. Third param is null only for JSONP requests.
        ...
        success?: (data?: any, statusCode?: number, xhr?: XMLHttpRequest | null, requestId?: number, url?: string, type?: string) => void;
        /**
         * Optional, default: `''`. If not set, result data will be processed/evaluated/parsed by response Content-Type HTTP header.
         * @type {string}
         */
        type?: 'json' | 'jsonp' | 'xml' | 'html' | 'text';
        /**
        ...
        error?: (responseText?: string, statusCode?: number, xhr?: XMLHttpRequest | null, requestId?: number, url?: string, type?: string) => void;
        /**
         * Optional, default: `{}`. Custom request HTTP headers to send in request.
         * @type {object}
         */
        headers: object;
        /**
         * Optional, default: `true`. Use old synchronized request only if you realy know what you are doing.
         * @type {boolean}
         */
        async: boolean;
    }
