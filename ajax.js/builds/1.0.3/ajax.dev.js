...
*/
var Ajax = (function (_globalScope) {
	/**
	 * @typedef		Ajax
	 * @type		{Function}
	 * @access		public
	...
	*/
	...
	// set Ajax object into parent environment under 'Ajax' key
	_globalScope.Ajax = Ajax;

	// return Ajax object into parent environment
	return Ajax;

	/**
	 * Define parent environment:
	 * If module.exports object exists (Node.js):
	 * - define Ajax helper into it
	 * If not:
	 * - define Ajax helper into this
	 * - which should be window object in browsers
	 */
})(Boolean(typeof (module) !== 'undefined' && module.exports) ? module.exports : this);